...
export const ONE_CONTRACT = 1_000_000n;
export const COLLATERAL_DECIMALS = 6;
export const PRICE_SCALE = 1_000_000n; // 900000 = 90% probability
...
export const SOMNIA_GAS_SETTINGS = {
  ...
  maxFeePerGas: 10_000_000_000n,        // 10 gwei max fee (safe headroom above 6 gwei base)
};
